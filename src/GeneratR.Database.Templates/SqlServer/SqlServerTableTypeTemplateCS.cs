...
{
    public class SqlServerTableTypeTemplateCS : StringTemplateBase
    {
        ...
        public SqlServerTableTypeTemplateCS(SqlServerTableTypeConfiguration dbObject, SqlServerSchemaGenerator schemaGenerator)
        {
            _obj = dbObject;
            _schemaGenerator = schemaGenerator;
            _dotNetGenerator = schemaGenerator.DotNetGenerator;
            _objSettings = schemaGenerator.Settings.TableType;
        }
